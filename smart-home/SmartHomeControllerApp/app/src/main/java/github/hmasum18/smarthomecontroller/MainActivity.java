...
//                Log.d(TAG, msg.obj.toString());
                switch (msg.what){
                    ...
                    case MESSAGE_READ:
                        ...
                        if (arduinoMsg.startsWith("Temperature: "))
                            mVB.tempText.setText(arduinoMsg+" C");
                        else if (arduinoMsg.startsWith("Humidity: "))
                            mVB.humText.setText(arduinoMsg+"%");
                        else
                            if (arduinoMsg.startsWith("Alert: "))
                            mVB.alertText.setText(arduinoMsg);

                        Log.w(TAG, "handleMessage: " + arduinoMsg);
